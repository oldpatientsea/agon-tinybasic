...
#
# ZDS II Make File - tinybasic project, Debug configuration
#
...
# project directory
PRJDIR = C:\source\Agon\tinybasic
PRJDIR_ESCSPACE = C:\source\Agon\tinybasic

# intermediate files directory
WORKDIR = C:\source\Agon\tinybasic\Debug
WORKDIR_ESCSPACE = C:\source\Agon\tinybasic\Debug

# output files directory
OUTDIR = C:\source\Agon\tinybasic\Debug\
OUTDIR_ESCSPACE = C:\source\Agon\tinybasic\Debug\
...
LDFLAGS = @..\tinybasic.linkcmd
build: tinybasic relist

buildall: clean tinybasic relist

relink: deltarget tinybasic

deltarget: 
	@if exist "$(WORKDIR)\tinybasic.lod"  \
            $(RM) "$(WORKDIR)\tinybasic.lod"
	@if exist "$(WORKDIR)\tinybasic.hex"  \
            $(RM) "$(WORKDIR)\tinybasic.hex"
	@if exist "$(WORKDIR)\tinybasic.map"  \
            $(RM) "$(WORKDIR)\tinybasic.map"
...
relist: 
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\tinybasic\Debug\tinybasic.map" \
            C:\source\Agon\tinybasic\init.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\tinybasic\Debug\tinybasic.map" \
            C:\source\Agon\tinybasic\Debug\main.src
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\tinybasic\Debug\tinybasic.map" \
            C:\source\Agon\tinybasic\mos-interface.asm
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\tinybasic\Debug\tinybasic.map" \
            C:\source\Agon\tinybasic\Debug\vdp.src
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\tinybasic\Debug\tinybasic.map" \
            C:\source\Agon\tinybasic\Debug\agontimer.src
	$(AS) $(ASFLAGS) -relist:"C:\source\Agon\tinybasic\Debug\tinybasic.map" \
            C:\source\Agon\tinybasic\agontimer-timer0.asm
